...
class ProductDesignObserver
{
    public function created(ProductDesign $design): void
    {
        try {
            ...
            Log::error('ProductDesignObserver: error al enviar notificación', [
                'design_id' => $design->id,
                'error'     => $e->getMessage(),
            ]);
        }
