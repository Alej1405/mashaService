...
use App\Filament\Cms\Resources\CmsTestimonialResource\Pages;
...
class CmsTestimonialResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\ImageColumn::make('autor_foto')->label('')->circular()->size(40),
                Tables\Columns\TextColumn::make('autor_nombre')->label('Cliente')->searchable()->weight('semibold'),
                Tables\Columns\TextColumn::make('autor_empresa')->label('Empresa')->color('gray'),
                Tables\Columns\TextColumn::make('estrellas')->label('★')
