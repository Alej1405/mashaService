...
use App\Filament\Cms\Resources\CmsServiceResource\Pages;
                ...
                Forms\Components\Repeater::make('caracteristicas')
                    ...
                    ->schema([
                        Forms\Components\TextInput::make('texto')
                            ->label('Característica')->required()->maxLength(200)->placeholder('Ej: Entrega en 24 horas'),
                    ])
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('titulo')->label('Servicio')->searchable()->weight('semibold'),
