...
use App\Filament\Resources\SystemEventResource\Pages;
...
class SystemEventResource extends Resource
{
    ...
    protected static ?string $navigationLabel  = 'Eventos del Sistema';
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\BadgeColumn::make('tipo')
                    ->label('Tipo')
                    ->colors([
                        'danger'  => fn ($s) => in_array($s, ['error', 'job_fallido']),
                        'warning' => 'warning',
                        'info'    => 'info',
                    ])
