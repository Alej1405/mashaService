                    ...
                    <div class="border-t border-gray-100 px-5 py-4 space-y-4">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-2">
                            ...
                            <div class="flex items-center gap-2 flex-wrap">
                                ...
                                <span class="text-sm font-bold text-orange-600">${{ number_format($billing->total, 2) }}</span>
                                <button onclick="abrirModal('modal-nv-{{ $pkg->id }}')"
                        ...
                        <div>
                            ...
                            @if($claimVerif)
                                {{-- Pago verificado --}}
                                <div class="flex items-center gap-2 rounded-lg bg-green-50 border border-green-200 px-4 py-3">
                                ...
                                <form action="{{ route('portal.payments.store', $empresa->slug) }}"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <p class="text-xs text-gray-500">
                                            Monto a pagar: <strong class="text-orange-600">${{ number_format($billing->total, 2) }}</strong>
                                        </p>
                                        <button type="submit"
                            ...
                            <div class="overflow-y-auto flex-1 p-5" id="nv-print-{{ $pkg->id }}">
                                ...
                                <div class="border border-t-0 border-gray-200 rounded-b-xl overflow-hidden mb-4">
                                    ...
                                    <div class="border-t-2 border-gray-200 bg-gray-50 px-5 py-3">
                                        <div class="max-w-[200px] ml-auto space-y-1 text-sm">
