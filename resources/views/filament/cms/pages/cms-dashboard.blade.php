            ...
            <div class="cms-panel">
                ...
                @php
                    $sections = [
                        ...
                        [
                            'label'  => 'Productos CMS',
                            'desc'   => 'Catálogo visible en el sitio web',
                            'count'  => $productsCount,
                            ...
                            'index'  => route('filament.cms.resources.cms-products.index',  ['tenant' => $tenant]),
                            'create' => route('filament.cms.resources.cms-products.create', ['tenant' => $tenant]),
                        ],
                    ];
                @endphp
